...
import {getEnvVar, getTfVar} from "./util/Env.js";
...
async function addServer() {
    ...
    process.env.TF_VAR_server_location = getTfVar("server_location") ?? await Input.select("serverLocation", "Server location:", serverLocations);
    process.env.TF_VAR_server_name = getTfVar("server_name") ?? await Input.askServerName(environment);
    if (getEnvVar("SERVER_NAME_PREFIX")) {
